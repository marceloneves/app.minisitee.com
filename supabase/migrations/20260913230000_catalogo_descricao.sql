-- A pagina publica passa a trazer a descricao de cada ferramenta: e o texto
-- que vai no alt e no title das imagens enviadas pelo dono. Resto igual a
-- 20260913220000_formato_logo.sql.
    ...
    'items', coalesce((
      ...
      from (
        select it.id, it.slug, it.title, it.kind, it.category, it.status,
               ...
               it.url, it.whatsapp_message, it.data, it.description,
